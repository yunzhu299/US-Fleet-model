#!/usr/bin/env Rscript
# Figure 6: annual North American vehicle retirements by powertrain.
...
year_min <- 2020
year_max <- 2050
plot_type <- "Retirement"
value_prefix <- "ret_"
figure_title <- "North America Annual Vehicle Retirement by Powertrain"
y_title <- "Retirements (thousand vehicles)"
output_name <- "Fig06_North_American_Vehicle_Retirements.png"
y_max_non_mx <- 1700
y_max_mx <- 1500
...
write_csv(
  plot_data,
  file.path(data_dir, "Fig06_North_American_Vehicle_Retirements.csv")
)
