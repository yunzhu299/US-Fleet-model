...
# U.S. registrations used by 002, 003, and 005. Loading them here makes the
# numbered pipeline reproducible in a fresh R session.
regs <- read_excel(
  "Inputs/LDV registration and sales.xlsx",
  sheet = "registrations "
)
# IHS MOVES Data
