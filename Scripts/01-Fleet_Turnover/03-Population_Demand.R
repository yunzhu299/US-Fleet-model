...
# Retirement-based export factors are intentionally not calculated here.
# Script 005 completes turnover once, derives the 2020-2024 ratios from those
# simulated retirements, and post-adjusts the domestic battery flows from that
# same pass. Keeping only the trade numerator here removes the former 003 <->
# 005 circular dependency and makes a clean run possible without stale Outputs.
