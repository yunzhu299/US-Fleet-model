...
# 4) Save to CSV
# -----------------------------
write.csv(canada_pop_long, "Inputs/Parameters/CanadaPopulation.csv", row.names = FALSE)
cat("\nSaved to Inputs/Parameters/CanadaPopulation.csv\n")

# Also save wide format for reference
write.csv(pop_data, "Inputs/Parameters/CanadaPopulation_wide.csv", row.names = FALSE)
cat("Saved wide format to Inputs/Parameters/CanadaPopulation_wide.csv\n")
...
write.csv(regs_2020_total, "Inputs/Parameters/Canada_Registrations_2020.csv", row.names = FALSE)
cat("\nSaved: Inputs/Parameters/Canada_Registrations_2020.csv\n")
...
write.csv(regs_2020_by_pt_wide, "Inputs/Parameters/Canada_Registrations_2020_byPT.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_Registrations_2020_byPT.csv\n")

# Type share 2020
write.csv(canada_type_share_2020, "Inputs/Parameters/Canada_TypeShare_2020.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_TypeShare_2020.csv\n")

# ICE pool 2020
write.csv(canada_ice_pool_2020, "Inputs/Parameters/Canada_ICE_Pool_2020.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_ICE_Pool_2020.csv\n")

# Full cleaned data (all years, all fuel types)
write.csv(regs_clean, "Inputs/Parameters/Canada_Registrations_AllYears.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_Registrations_AllYears.csv\n")
...
# -----------------------------
write.csv(canada_ev_historical_long, "Inputs/Parameters/Canada_EV_Historical.csv", row.names = FALSE)
cat("\nSaved: Inputs/Parameters/Canada_EV_Historical.csv\n")
...
write.csv(canada_ev_summary, "Inputs/Parameters/Canada_EV_Historical_Summary.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_EV_Historical_Summary.csv\n")
...
# -----------------------------
write.csv(canada_pr_accii, "Inputs/Parameters/Canada_PR_ACCII.csv", row.names = FALSE)
cat("\nSaved: Inputs/Parameters/Canada_PR_ACCII.csv\n")

write.csv(canada_pr_repeal, "Inputs/Parameters/Canada_PR_Repeal.csv", row.names = FALSE)
cat("Saved: Inputs/Parameters/Canada_PR_Repeal.csv\n")
...
if (!exists("us_avg_by_year_age_by_type")) {
  ...
  # Save
  write.csv(canada_age_dist, "Inputs/Parameters/Canada_AgeDistribution.csv", row.names = FALSE)
  cat("\nSaved: Inputs/Parameters/Canada_AgeDistribution.csv\n")
}
...
if (file.exists("Inputs/CanadaSale.xlsx")) {
  ...
  # Save
  write.csv(canada_total_sales, "Inputs/Parameters/Canada_TotalSales_Detail.csv", row.names = FALSE)
  cat("\nSaved: Inputs/Parameters/Canada_TotalSales_Detail.csv\n")
  
  write.csv(canada_total_by_year_seg, "Inputs/Parameters/Canada_TotalSales_bySegment.csv", row.names = FALSE)
  cat("Saved: Inputs/Parameters/Canada_TotalSales_bySegment.csv\n")
...
cat("========================================\n")
cat("\nOutput files in Inputs/Parameters/ folder:\n")
